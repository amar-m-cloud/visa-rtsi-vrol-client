...
public class TransactionSummaryType {
    ...
    @XmlElement(name = "SpecialMerchantID")
    protected String specialMerchantID;
    @XmlElement(name = "ParceladoPaymentType")
     ...
     *     
     */
    public void setSpecialMerchantID(String value) {
     ...
     *     
     */
    public void setParceladoPaymentType(String value) {
     ...
     *     
     */
    public void setRdrEligibilityInd(Boolean value) {
